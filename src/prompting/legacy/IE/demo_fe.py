...
demo1 = {
    ...
    "screenwriter.",
    "output": "[s] Vettaikaaran_(2009_film) [r] original language of film or TV show [o] Tamil_language [e] "
...
demo3 = {
    ...
    "output": "[s] Abhishek_Pictures [r] industry [o] Film_industry [e] "
...
demo4 = {
    ...
    "output": "[s] Swedish_Open_Cultural_Heritage [r] main subject [o] Cultural_heritage [e] "
    ...
    "[s] Swedish_Open_Cultural_Heritage [r] file format [o] XML [e] "
    "[s] Swedish_Open_Cultural_Heritage [r] file format [o] JSON [e] "
    "[s] Swedish_Open_Cultural_Heritage [r] file format [o] JSON-LD [e] "
    "[s] XML [r] inspired by [o] Standard_Generalized_Markup_Language [e]",
}
...
demo6 = {
    ...
    "output": "[s] Marcus_Jacob_Monrad [r] place of death [o] object [e] [s] Marcus_Jacob_Monrad [r] place of burial [o] "
    "Cemetery_of_Our_SaviourCemetery_of_Our_Saviour [e] [s] Marcus_Jacob_Monrad [r] religion [o] Lutheranism [e]",
}
...
demo7 = {
    ...
    "output": "[s] The_Making_of_Maddalena [r] director of photography [o] James_Van_Trees [e] [s] The_Making_of_Maddalena [r] color [o] black_and_white [e] [s] The_Making_of_Maddalena [r] cast member [o] Edna_Goodrich [e]",
}
...
demo11 = {
    ...
    "output": "[s] Archibald_Campbell,_2nd_Earl_of_Argyll [r] noble title [o] Earl [e] [s] Archibald_Campbell,_2nd_Earl_of_Argyll [r] described by source [o] Nordisk_familjebok [e] [s] Archibald_Campbell,_2nd_Earl_of_Argyll [r] family [o] Clan_Campbell [e]",
}
...
demo12 = {
    ...
    "output": "[s] Arena_Zagreb [r] owned by [o] Zagreb [e] [s] Arena_Zagreb [r] occupant [o] RK_Zagreb [e] [s] Arena_Zagreb [r] sport [o] Tennis [e] [s] Arena_Zagreb [r] significant event [o] groundbreaking [e]",
}
...
demo14 = {
    ...
    "output": "[s] Kensington_and_Chelsea_TMO [r] located in the administrative territorial entity [o] Kensington [e] [s] Kensington_and_Chelsea_TMO [r] legal form [o] Limited_company [e] [s] Kensington_and_Chelsea_TMO [r] board member [o] Emma_Dent_Coad [e]",
}
...
# num_demo= 13 => 2063 overhead tokens
# num_demo= 12 => 1868 overhead tokens
# num_demo= 11 => 1737 overhead tokens, below 2048-256=1792
